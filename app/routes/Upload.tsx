...
import { generateUUID } from "~/helperFunctions/GenerateUUID";
...
const Upload: () => JSX.Element = () => {
  ...
  const handleAnalyze = async ({
    ...
    if(!imageFile.file) return setStatusText('Error to conver to image');
        ...
        <div className="page-heading py-16">
          ...
          {!isProcessing && (
            ...
            >
              ...
              <div className="form-div">
                <label htmlFor="uploader">Upload Resmume</label>
